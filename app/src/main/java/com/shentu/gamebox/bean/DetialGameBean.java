...
public class DetialGameBean implements Serializable {
    ...
    private String rebate_detail;


    public String getRebate_detail() {
        return rebate_detail;
    }

    public void setRebate_detail(String rebate_detail) {
        this.rebate_detail = rebate_detail;
    }
