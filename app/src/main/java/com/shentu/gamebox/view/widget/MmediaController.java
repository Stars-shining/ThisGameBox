package com.shentu.gamebox.view.widget;
...
import com.shentu.gamebox.utils.MTimeUtils;
...
//        requestOrien = controllerView.findViewById(R.id.request_orien);
        stop$play = controllerView.findViewById(R.id.stop_play);
    ...
    private void initListener() {
        ...
        voiceSwitch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                boolean tag = voiceSwitch.getTag() != null && (boolean) voiceSwitch.getTag();
